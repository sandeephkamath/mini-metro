...
| Restart | Click "Back to Home" on the Game Over screen | Phase returns to `home` with a fresh game state (score 0, week 0); clicking Play again returns directly to `playing` (`themes/home_screen.md`) |
